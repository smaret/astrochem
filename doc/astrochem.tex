...
\begin{figure}
  \begin{center}
    \includegraphics[height=10cm]{examples/abundances.pdf}
  \end{center}
...
\begin{figure}
  \begin{center}
    \includegraphics[width=\columnwidth]{examples/routes.pdf}
  \end{center}
...
\begin[h]{table}
  \begin{center}
    ...
    \begin{tabular}{llccc}
      \hline
      \hline
      Type number & Equation\footnotemark[1] & \multicolumn{3}{c}{Rate constants\footnotemark[2]}\\
      \cline{3-5}
      & & $a$ & $b$ & $c$\\
      \hline
      ...
      22    & Eq.~(\ref{eq:cosmic-ray-desorption}) & - & $m/m_\mathrm{H}$ & $E_{b}$\\
