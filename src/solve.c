      ...
      if (input_params->output.trace_routes)
      {
        for (j = 0; j < input_params->output.n_output_species; j++)
        {
          ...
          for (k = 0; k < network->n_reactions; k++)
          {
            ...
            if ((network->reactions[k].product1 == input_params->output.output_species_idx[j]) ||
                (network->reactions[k].product2 == input_params->output.output_species_idx[j]) ||
                (network->reactions[k].product3 == input_params->output.output_species_idx[j]) ||
                (network->reactions[k].product4 == input_params->output.output_species_idx[j]))
            {
              r_t formation_route;
              double min_rate;
            ...
            if ((network->reactions[k].reactant1 == input_params->output.output_species_idx[j]) ||
                (network->reactions[k].reactant2 == input_params->output.output_species_idx[j]) ||
                (network->reactions[k].reactant3 == input_params->output.output_species_idx[j]))
            {
